...
const projects = [
  {
    ...
    category: "DatiVe Design",
    description: "Etykieta wyróżniająca się czystością formy, świeżością i nowoczesnym charakterem.",
    tags: ["#LabelDesign", "#PackagingDesign"],
    reactions: "2 reakcje",
    image: PACKAGING_IMG,
  },
  {
            ...
            {projects.map((project, i) => (
              <AnimatedSection key={i}>
                ...
                >
                  ...
                  <div className="absolute top-4 right-4 px-2 py-0.5 bg-background/80 backdrop-blur-sm border border-white/10 rounded-full text-[10px] text-white/50 font-display">
                    ♥ {project.reactions}
                  </div>
                </motion.div>
              </AnimatedSection>
