      ...
      <section className="relative overflow-hidden border-b border-white/5">
        ...
        <div className="relative container py-24 sm:py-28 lg:py-36">
          <div className="max-w-5xl">
            <div className="section-label mb-5">{hero.label}</div>
            <h1 className="max-w-4xl font-display text-4xl font-black leading-[0.94] text-white sm:text-6xl lg:text-8xl">
            ...
            <div className="mt-10 flex flex-wrap gap-5 text-sm text-white/55">
