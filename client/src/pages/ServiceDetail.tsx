  ...
  return (
    <SiteLayout>
      <section className="container py-20 sm:py-24">
        <div className="grid gap-14 xl:grid-cols-[1.05fr_0.95fr]">
          <div className="grid gap-16">
            <div>
              <div className="section-label mb-4">{service.category}</div>
              <h1 className="font-display text-4xl font-black text-white sm:text-5xl lg:text-6xl">
                {service.name}
              </h1>
              <p className="mt-4 text-xl text-gold">{service.tagline}</p>
            ...
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
              <div className="rounded-sm border border-white/8 bg-card p-4">
                <div className="text-xs font-bold uppercase tracking-[0.2em] text-white/35">
                  {locale === "en" ? "Starting from" : "Start od"}
                </div>
                <div className="mt-3 font-display text-2xl font-black text-gold">
          ...
          <aside className="product-panel self-start rounded-sm border border-gold/20 p-6 sm:p-8 xl:sticky xl:top-24">
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-3 xl:grid-cols-1 2xl:grid-cols-3">
              <div className="rounded-sm border border-white/10 bg-background/80 p-4">
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        <div className="font-display text-xl font-black text-white">{item.name}</div>
            ...
            {shopConfig.length > 0 ? (
              <div className="mt-8 grid gap-5">
                ...
                {shopConfig.map((field) => (
                  <div key={field.id} className="rounded-sm border border-white/10 bg-background p-4">
                    <div className="font-bold text-white">{field.label}</div>
                    {field.description ? (
                      <p className="mt-1 text-sm leading-relaxed text-white/50">{field.description}</p>
                    ) : null}
                      ...
                      {field.choices.map((choice) => {
                        ...
                        return (
                          <button
                            ...
                            className={`flex items-center justify-between gap-4 rounded-sm border px-4 py-3 text-left text-sm transition-colors ${
                              isActive
            ...
            <div className="mt-8 grid gap-4">
              ...
              <input
                ...
                className="h-12 rounded-sm border border-white/10 bg-background px-4 text-sm text-white outline-none"
              />
              <input
                value={scopeDetails}
              ...
              <textarea
                ...
                className="min-h-28 rounded-sm border border-white/10 bg-background px-4 py-3 text-sm text-white outline-none"
              />
            </div>

            <div className="mt-8 rounded-sm border border-white/10 bg-background p-5">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <div className="font-display text-xl font-black text-white">{selectedPackage.name}</div>
              ...
              <button
                ...
                className="gold-button-shimmer mt-6 inline-flex w-full items-center justify-center gap-2 rounded-sm px-6 py-4 text-sm font-black uppercase tracking-wider text-background"
              >
                <ShoppingBag size={16} />
              ...
              <Link
                ...
                className="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-sm border border-gold/30 px-6 py-4 text-sm font-black uppercase tracking-wider text-gold"
              >
                {locale === "en" ? "Go to cart" : "Przejdź do koszyka"}
              </Link>
              <Link
                href={getStaticPath("order")}
                className="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-sm border border-white/10 px-6 py-4 text-sm font-black uppercase tracking-wider text-white/65"
              >
